...
\begin{tabular}{@{}p{3cm}cccp{1.8cm}c@{}}
\toprule
\textbf{Method} & \textbf{Year} & \textbf{Energy Saving} & \textbf{Acc. Impact} & \textbf{Dual-Layer} \\
\midrule
Adaptive Threshold \cite{atitallah2023autonomous} & 2023 & 17.3\% (reduct.) & $\pm$11.7\% & No \\
SAX-LZW \cite{aljanabi2022sax} & 2022 & $\sim$40\% data red. & $\sim$5\% loss & No \\
Bounded-Error \cite{azar2020bounded} & 2020 & $\sim$35\% data red. & Bounded & No \\
...
\textbf{VABQ (Proposed)} & \textbf{2026} & \textbf{64.6\% total} & \textbf{1.6\% loss} & \textbf{Yes} \\
\bottomrule
\end{tabular}
\end{table}
